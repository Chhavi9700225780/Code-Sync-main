        ...
        <div className="relative min-h-screen overflow-hidden bg-[#1E293B]">
            ...
            <div className="relative">
                <div className="container mx-auto px-4 py-12">
                    {/* Large Centered Logo */}
                    <motion.div
                        className="mb-16 flex justify-center pt-8"
                    ...
                    <div className="grid grid-cols-1 items-start gap-16 lg:grid-cols-2 lg:gap-24">
                        ...
                        <div className="relative z-10 space-y-8">
                            ...
                            <motion.h1
                                className="text-center text-5xl font-bold leading-[1.1] text-white md:text-6xl lg:text-left lg:text-7xl xl:text-8xl"
                            ...
                            <motion.div
                                className="relative rounded-xl border border-gray-700 bg-gray-900/80 p-6 backdrop-blur-sm"
                                initial={{ opacity: 0, y: 20 }}
                                animate={{ opacity: 1, y: 0 }}
                            ...
                            {/* Stats Row */}
                            <motion.div
                                className="grid grid-cols-3 gap-6 rounded-xl border border-gray-700/50 bg-darkHover/50 p-6 text-center backdrop-blur-sm"
                                initial={{ opacity: 0, y: 20 }}
                                animate={{ opacity: 1, y: 0 }}
                        ...
                        {/* Right: 3D Code Scene */}
                        <motion.div
                            className="relative z-10 flex h-[600px] items-center justify-center lg:justify-end"
            ...
            <div id="features" className="container relative z-10 mx-auto px-4 py-24">
                <motion.div
            ...
            {/* Footer */}
            <motion.div
                className="relative z-10 border-t border-gray-800 py-12"
                initial={{ opacity: 0 }}
                ...
                <div className="container mx-auto px-4">
                    <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
                        <div className="flex items-center gap-3">
                            <Logo className="h-8" />
                            <span className="text-gray-400">Code Sync</span>
                        </div>
